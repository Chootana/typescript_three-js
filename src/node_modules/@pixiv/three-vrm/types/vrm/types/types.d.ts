 ...
 */
export declare type GLTFPrimitive = THREE.Mesh<THREE.BufferGeometry, THREE.Material | THREE.Material[]> | THREE.SkinnedMesh<THREE.BufferGeometry, THREE.Material | THREE.Material[]>;
/**
 * A single mesh of GLTFs, represented as a Three.js object;
 *
 * See: https://github.com/KhronosGroup/glTF/tree/master/specification/2.0#meshes
 */
export declare type GLTFMesh = THREE.Group | THREE.Mesh<THREE.BufferGeometry, THREE.Material | THREE.Material[]> | THREE.SkinnedMesh<THREE.BufferGeometry, THREE.Material | THREE.Material[]>;
/**
